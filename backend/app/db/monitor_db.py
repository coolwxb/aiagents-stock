...
class StockMonitorDatabase:
    ...
    def __init__(self, db_path: str = None):
        if db_path is None:
            from app.db.db_path import get_db_path, DB_STOCK_MONITOR
            db_path = get_db_path(DB_STOCK_MONITOR)
    ...
    def get_monitor_by_code(self, symbol: str) -> Optional[Dict]:
        ...
        cursor.execute('SELECT * FROM monitored_stocks WHERE symbol = ?', (symbol,))
