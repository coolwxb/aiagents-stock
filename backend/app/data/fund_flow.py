...
from app.data.data_source import data_source_manager, DataSourceManager
...
class FundFlowAkshareDataFetcher:
    ...
    def __init__(self, data_source_manager_instance: DataSourceManager = None):
        ...
        Args:
            data_source_manager_instance: 数据源管理器实例
                                         如果为 None，则使用全局默认实例
        """
            ...
            if df is None or df.empty:
                ...
                if self.data_source_manager.tushare_available:
                    try:
                        ...
                        # 获取资金流向数据
                        df = self.data_source_manager.tushare_api.moneyflow(
                            ts_code=ts_code,
